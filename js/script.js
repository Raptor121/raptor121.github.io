...
document.addEventListener('DOMContentLoaded', function() {
  ...
  totalPriceElement.innerHTML = '0 lei';
  ...
  addButtons.forEach(function(button) {
    button.addEventListener('click', function() {
      ...
      totalPriceElement.innerHTML = (parseInt(totalPriceElement.innerHTML) + price * count) + ' lei';
...
function removeFromCart(key) {
  ...
  totalPrice.innerHTML = parseInt(totalPrice.innerHTML) - total + " lei";
...
function Remove($key){
    ...
    if(item){
        ...
        totalPriceElement.innerHTML = (parseFloat(totalPriceElement.innerHTML.split(' ')[0]) - price * count) + ' lei';
        item.remove();
    }
}
...
document.querySelector('.promo-code-button').addEventListener('click', function() {
  ...
  if (promoCode === 'xb3') {
    ...
    document.querySelector('.total-price').innerHTML = (totalPrice * 0.9) + ' lei';
    document.querySelector('.promo-code-input').value = '';
    document.querySelector('.promo-code-button').setAttribute("disabled", "true");
  }
});
